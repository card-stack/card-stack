import { toHex, extractIndex, HexByte } from '.';
...
describe('utils', () => {
	...
	describe('extractIndex', () => {
		...
		it('accepts a HexByte value as a mask', () => {
			expect(extractIndex(0x789e27e011, HexByte.CARD_RANK)).toBe(0x0000000011);
			expect(extractIndex(0x789e27e011, HexByte.CARD_SUIT)).toBe(0x000000e000);
			expect(extractIndex(0x789e27e011, HexByte.CARD_INDEX)).toBe(0x0000270000);
			expect(extractIndex(0x789e27e011, HexByte.DECK_INDEX)).toBe(0x009e000000);
			expect(extractIndex(0x789e27e011, HexByte.PARENT_INDEX)).toBe(
				0x7800000000,
			);
		});
	});
